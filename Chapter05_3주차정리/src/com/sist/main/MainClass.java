 ...
 *                                => 데이터 목록
 *               예)
 *                   String name; => 자동 초기화 : 클래스인 경우 => null값으로 초기화
 ...
 *                  }               
 *               3) 자바의 모든 클래스는 object 클래스 생성
 *                                 ---------------
 *                  class A extends Object
 *                          -------------- => Object에서 지원하는 모든
 *               4) 생성자가 없는 경우 => 자동으로 디폴트 생성자 추가
 *               5) 자바의 모든 클래스는 예외처리를 갖고 있다
 *                                 ------
 *                                    |
 *                                  컴파일시/런타임시
 *                                        ------
 ...
 *                                ------- substring(), substring(int s,int e)
 *          (3) 사용처
 ...
 *                     static 
 *                     {
 *                       a=1000; => error  ==> 오류 , static블록에는 인스턴스 불가능
