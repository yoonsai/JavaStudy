 ...
 *     = ***java.text => DecimalFormat/SimpleDataFormat
 *     자바 ===> 2차 자바 : 브라우저(Web)
 *             3차 자바 : Spring(핵심)
 *     ------------------------------------------------------
 *     1) IO
 ...
 *        -----------------------------------------------------------
 *                *** 스트림은 데이터 이동통로
 *                    ----- 읽기/쓰기 => 단방향통신 => 두개 프로그램을 동시에 수행 (쓰레드)
 *                          => 네트워크 
 *                          => 웹에서는 이미 서버가 만들어져 있다
 *                             => 기능 추가(톰캣=자바엔진=테스트서버)
 *                                       ---- 50명
 ...
 *                  => 메모리에 전체를 저장 (속도가 빠르다)   **ObjectOutputStream
 *               *ObjectInputStream
 *                  => 객체 단위 저장 (***)
 *                  
