...
/*
 *   ==> 객체지향에 연연하지 말고..
 *   객체지향의 3대 특성 => 문법사항이 아님, 권장사항
 *   --------------
 *   class Window extends JFrame => 재사용 => 상속
 *     => 변경 사항이 있는 경우
 *   class Window
 *   {
 *       JFrame fr=new JFrame(); => 재사용 => 포함 => 변경사항이 없다
 *   }
 *   => 웹/스프링 => 상속이 거의 없다 => 포함
 *   
 *   1. 캡슐화 : 데이터 보호
 ...
 *                  만약 : 멤버변수, 멤버메소드를 사용할때는 반드시 객체 생성후에 사용
 *            class A{
 *               private int a;
 *               static int b;
 *               public void aaa()
 ...
 *                   a,b,bbb()
 *               }
 *               public static void bbb() =>객체가 공통으로 가진 메소드
 *               {
 *                   b=>사용이 가능
 *                   a.aaa() => 사용불가
 *                   A aa=new A();
