...
public class UserInfoPanel extends JFrame{
	...
	public void UserData(String[] info) {
		...
		if(info[2].equals("남자")) {
			img.setIcon(new ImageIcon(ImageChange.getImage(new ImageIcon("c:\\java_data\\Man1.jpg"), 90, 90)));
		}
		else {
			img.setIcon(new ImageIcon(ImageChange.getImage(new ImageIcon("c:\\java_data\\Woman1.jpg"), 90, 90)));
		}
	}
