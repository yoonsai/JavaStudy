...
{
	int a=10;
	static int b=20; //메모리에 저장완
	void aaa()
	{
		System.out.println(a); //System.out.println(this.a); this. 생략가능
		System.out.println(b);
	}
	static void bbb() // static은 static변수만 가능
	{
		A aa=new A();
		System.out.println(aa.a); //쓰려면 메모리 할당을 한 다음 사용 가능
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(A.b); // 클래스명으로도 접근 가능
