 ...
 *   ---------------------- 표준 자바 => javax (웹, 윈도우)
 *   JDK 1.0                          JDK 1.2
 *   => java.lang => 보통 package가 다르면 import를 사용해서 클래스를 가지고 온다 (java.lang은 생략이 가능)
 *    -------------
 ...
 *                4) equals() : 객체 비교시에 주로 사용 (대소문자 구분)
