...
public class FoodDetailPanel extends JPanel implements ActionListener{
	...
	public FoodDetailPanel(ControlPanel cp)
	{
		...
		nameLa.setBounds(320, 15, 450, 35);
		...
		la6.setBounds(320, 240, 70, 35);
		timeLa.setBounds(395, 240, 400, 35);
		add(la6);add(timeLa);
		
		la7.setBounds(320, 280, 70, 35);
		menuLa.setBounds(395, 280, 400, 35);
		add(la7);add(menuLa);
	...
	public void foodPrint(FoodHouseVO vo)
	{
		try {
			...
			URL url=new URL(vo.getPoster().substring(0,vo.getPoster().indexOf("?")));
