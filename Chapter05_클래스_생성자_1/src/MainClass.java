 ...
 *  }
 *  
 *  A => sawonSysyem s=new sawonSysyem();
 *       sawons[1]=A
 *  B => sawonSysyem s=new sawonSysyem();
 *       sawons[1]=A
 *  C => sawonSysyem s=new sawonSysyem();
 *       sawons[1]=A
 *  
 ...
 *             void aaa()
 *             {
 *               static int b; => 오류 / 메소드 안에서는 사용이 불가능
 *             }  
 *         }
 *         
 *         class A
...
class Sawon
{
	...
	Sawon(int s,String name,String dept,String job,String loc)
	{
		...
		sabun=s;
		this.name=name; //this.~ 멤버변수 => 클래스 자신의 객체명 / "="뒤에는 지역변수
		this.dept=dept;
		this.job=job;
		this.loc=loc;
		a=100; // 필기체는 static변수
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("근무지역:"+sa.loc);
		...
		System.out.println("근무지역:"+sa1.loc);
		...
		System.out.println("직위:"+sa2.job);
		System.out.println("근무지역:"+sa2.loc);
	}
