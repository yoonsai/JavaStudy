 ...
 *    ***for : 반복 횟수가 지정 (0번~)
 *    ***while : 반복 횟수 제한이 없는 경우 (게임, 네트워크 서버) (0번~)
 *    ---------- 종료(break), 특정부분 제외(continue)
 *    do~while : 무조건 한번 이상을 수행 (1번~)
 *    -------------------------------------------------------------
 ...
 *                           상세보기, 지도 .....
 *         1) 형식 => 54page
 *            if(조건문) : 조건문은 반드시 true/false => 부정연산자(!),비교연산자(==,!=,>,<),논리연산자(&&, ||)만 사용이 가능
 *            {
 *                조건이 true일때 실행하는 문장
 *            }
 *            
 ...
 *   
 */
public class A_제어문_조건문1 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		// 변수선언 => 데이터관리 => 저장(메모리) => 한개의 데이터 저장
		// 프로그램이 시작 => 데이터 저장, 연산자, 제어문 => 기초/필수
		// 데이터형 변수명
		int a=15;
		if (a%3==0) {
