 ...
 *       = 이미 사용중에 있다는 (신뢰성)
 *       => 재사용(상속,포함), 가독성(메소드로 구현), 견고성(예외처리)
 ...
 *              = 한개만 상속이 가능 (단일 상속)
 *              = 형식
 *                A extends B => B가 가지고 있는 모든 것을 가지고 온다 => 멤버변수, 공유변수, 메소드, 생성자, 초기화블록
 *                --하위클래스 --상위클래스                           -------        ----
 *                                                                 |            |
 *                                                             ---------------------
 *                                                          => 상속의 예외 조건
 ...
 *                     지니뮤직 ==> 상속 ==> 멜론
 *                  => Movie
 *                     CGV ==> 상속 ==> 롯데시네마/메가박스 (변경해서 사용)
 *                  **상속을 받는 경우 => 기능변경   /   기능 추가
 *                                   --------- ----------
 *                                   |오버라이딩    |오버로딩 => 다형성   
 *                  *** 객체지향의 3대 특성
