 ...
 *             ---------
 *              인터페이스에 메소드 추가가되면 문제 발생
 *              JDK 1.8 => 구현 메소드를 사용하게 만든다
 *                         --------
 *                         default / static
 *    => 소프트공항 : 인터페이스 고정을 해야된다
 * 3. 형식 => 247page
 ...
 *        ------------------------
 *    }
 *    인터페이스는 모든 접근지정어가 public(변수, 메소드) => 자동추가
 *    변수 => 반드시 명시적인 초기화를 한다
 *    int a; => int a=10;
 *        
 *        
...
//class B implements A
//{ 
//	public void disp() // 확대는 가능하지만 축소는 불가능 public메소드는 제일 큰 데이터형이라 축소가 불가능
//	{
//		
//	}
//}
