...
public class 배열_1 {
	...
	public static void main(String[] args) {
		...
		/*     
		 *    [I@6504e3b2[0] => 별칭을 arr로 주는것/ arr[0] => 일반 변수와 동일
		 *    -----------------------
		 *     0  | 0  | 0  | 0  | 0  
		 *   |-----------------------
		 *   [I@6504e3b2    20byte
		 *   
		 */
		int[] arr2=arr; // 얕은 복사(같은 것을 가지고 있는 것)
		...
		System.out.println(arr2); // 저장된 주소값이 같은 경우에는 같은 메모리를 제어한다 => 얕은 복사 => 배열,클래스
		// 배열이나 클래스인 경우에 같은 주소를 가지고 있으면 같은 메모리를 제어한다 => 얕은 복사 
